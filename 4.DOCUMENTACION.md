...
- **asciiDoc** 
_2: el más interesante. 3: es más potente que el 2(que está un poquito más limitado) rct, permite 2 índices y un montón de cosas_
...
- Distribuido
- Eficiente
_Git: Es el sistema de control de versiones propiamente dicho. No confunciar con GitHug: sitio web, servidor o conjunto de servisores, que trabaja con Git. Permite que subas el código y hacer control de versiones y demás de forma amigable a través de la web._
...
_Commit->Registro. Dos copias siempre, la remota y la local. A veces trabajan varias personas con el mismo código, se harían copias en local del código, y habría que tener en cuenta que hay que actualizar el remoto(posibles problemas)_
