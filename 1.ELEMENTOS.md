...
- La especificación de requisitos debe:
  ...
  _Cuando se va a diseñar una aplicación es lo primero que se hace, para saber exacatamente qué quiere el cliente._
...
- Tipos de mantenimiento:
  ...
  _El cliente la utiliza, y la empresa la mantiene (ej: Microsoft, Oracle...). Una vez que la empresa deja de dar mantenimiento de una aplicación (Windows XP, etc) el cliente puede elegir si seguir utilizándolo, aunque ya no habrá actualizaciones._
...
- Tipos de prototipos:
  ...
  - __Prototipos evolutivos__ 
    ...
    _Herramientas=entorno de desarrollo. Lenguaje C y ensablador, son los lenguajes más detallados, que se utiliza en programas definitivos, pero para hacer los prototipos rápidos, se utiliza por ejemplo Pythom._
...
_Modelo incremental, hay de 4 fases y de 6 fases, como el del dibujo, se empieza por el centro de la espiral. Cuando se da la primera vuelta y se vuelve a hablar con el cliente, se puede añadir algo... y continuar con la espiral._
...
- Las metodologías más conocidas son:
  ...
  _Son las que se utilizan en Aytos._
